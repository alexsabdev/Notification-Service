...
describe('E2E: notification-service', function() {
	...
	describe('showing and removing an alert', function() {
		...
		it('should close the alert on pressing the x span', function() {
			...
			expect(element(by.css('li')).isPresent()).toBeFalsy();
		});
	...
	describe('talking to server', function() {
		...
		// 		angular.module('httpBackendMock', ['Demo', 'notification-service', 'ngMockE2E'])
